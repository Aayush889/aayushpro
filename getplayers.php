...
.nav--txt {
    ...
    <body>
    <center class="new"><h1><a link href="teams.html">Search player by sports</a></h1></center>
            ...
            <?php
                ...
                if($result-> num_rows > 0){
                    while($row = $result-> fetch_assoc()){
                        echo "<tr><td>". $row["Player_id"]."</td><td>". $row["P_name"]."</td><td>". $row["sport"]."</td><td>". $row["address"]."</td><td>". $row["phone"]."</td><td>". $row["Team_id"]."</td><td>". $row["Coach_id"]."</td></tr>";
